...
INSERT INTO tool (tool_name, brand, description, checked_out, current_borrower, date_borrowed, due_date) VALUES ('Miter Saw', 'DeWaltDisney', 'A saw used to make accurate crosscuts and miters in a workpiece by pulling a large backsaw or a mounted circular saw blade down onto a board in a quick motion.', 0, null, null, null);
INSERT INTO tool (tool_name, brand, description, checked_out, current_borrower, date_borrowed, due_date) VALUES ('Miter Saw', 'GitBosch', 'A saw used to make accurate crosscuts and miters in a workpiece by pulling a large backsaw or a mounted circular saw blade down onto a board in a quick motion.', 0, null, null, null);
INSERT INTO tool (tool_name, brand, description, checked_out, current_borrower, date_borrowed, due_date) VALUES ('Miter Saw', 'KOBOL', 'A saw used to make accurate crosscuts and miters in a workpiece by pulling a large backsaw or a mounted circular saw blade down onto a board in a quick motion.', 0, null, null, null);
INSERT INTO tool (tool_name, brand, description, checked_out, current_borrower, date_borrowed, due_date) VALUES ('Miter Saw', 'SkillzFund', 'A saw used to make accurate crosscuts and miters in a workpiece by pulling a large backsaw or a mounted circular saw blade down onto a board in a quick motion.', 0, null, null, null);
INSERT INTO tool (tool_name, brand, description, checked_out, current_borrower, date_borrowed, due_date) VALUES ('Miter Saw', 'StanLee', 'A saw used to make accurate crosscuts and miters in a workpiece by pulling a large backsaw or a mounted circular saw blade down onto a board in a quick motion.', 0, null, null, null);
